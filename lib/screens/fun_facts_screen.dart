...
class _FunFactsScreenState extends State<FunFactsScreen> {
  ...
  final List<_SliderPage> _pages = const [
    _SliderPage(
      ...
      image: "images/fun_facts/Being-Healthy-Streamline-Tokyo.png",
    ),
    _SliderPage(
      description:
      ...
      image: "images/fun_facts/Order-Groceries-Online-Streamline-Tokyo.png",
    ),
    _SliderPage(
      description:
          "Satu bungkus mi instan bisa mengandung lebih dari 1.200 mg natrium, setara dengan 60% batas konsumsi garam harian.",
      image: "images/fun_facts/Fast-Food-2-Streamline-Tokyo.png",
    ),
    _SliderPage(
      description:
      ...
      image: "images/fun_facts/Order-Groceries-Online-2-Streamline-Tokyo.png",
    ),
  ];
